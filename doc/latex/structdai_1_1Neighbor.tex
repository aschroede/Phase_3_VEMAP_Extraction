...
\mbox{\hyperlink{structdai_1_1Neighbor_a4b9a406caa565f6b75824db1df18b0ee}{Neighbor}} (size\+\_\+t \mbox{\hyperlink{structdai_1_1Neighbor_ade0af4c962de1250e818badfdfb92ae5}{iter}}, size\+\_\+t \mbox{\hyperlink{structdai_1_1Neighbor_a1b9eb43d9c57bc445b733287fa6abbdf}{node}}, size\+\_\+t \mbox{\hyperlink{structdai_1_1Neighbor_a0e6674603c16566ea6500830c915805e}{dual}})
...
\mbox{\hyperlink{structdai_1_1Neighbor_a52a8e1b68316edf7616d99f6fb4dc553}{operator size\+\_\+t}} () const
...
\begin{DoxyCompactItemize}
\item 
size\+\_\+t \mbox{\hyperlink{structdai_1_1Neighbor_ade0af4c962de1250e818badfdfb92ae5}{iter}}
...
size\+\_\+t \mbox{\hyperlink{structdai_1_1Neighbor_a1b9eb43d9c57bc445b733287fa6abbdf}{node}}
\begin{DoxyCompactList}\small\item\em Contains the absolute index of the neighboring node. \end{DoxyCompactList}\item 
size\+\_\+t \mbox{\hyperlink{structdai_1_1Neighbor_a0e6674603c16566ea6500830c915805e}{dual}}
...
\DoxyCodeLine{\ \ \ \ \textcolor{keywordtype}{size\_t}\ \_j\ =\ 0;}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{util_8h_ab712ec4331593f848c40b97a80186850}{bforeach}}(\ \textcolor{keyword}{const}\ \mbox{\hyperlink{structdai_1_1Neighbor_adc0642fac15ade6ab1451708c8623114}{Neighbor}}\ \&j,\ nb(i)\ )\ \{}
\DoxyCodeLine{\ \ \ \ \ \ \ \ assert(\ j\ ==\ nb(i,j.iter)\ );}
\DoxyCodeLine{\ \ \ \ \ \ \ \ assert(\ nb(j.node,j.dual).node\ ==\ i\ );}
\DoxyCodeLine{\ \ \ \ \ \ \ \ assert(\ \_j\ =\ j.iter\ );}
\DoxyCodeLine{\ \ \ \ \ \ \ \ \_j++;}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{\}}
...
{\footnotesize\ttfamily dai\+::\+Neighbor\+::\+Neighbor (\begin{DoxyParamCaption}\item[{size\+\_\+t}]{iter,  }\item[{size\+\_\+t}]{node,  }\item[{size\+\_\+t}]{dual }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily dai\+::\+Neighbor\+::operator size\+\_\+t (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily size\+\_\+t dai\+::\+Neighbor\+::iter}
...
{\footnotesize\ttfamily size\+\_\+t dai\+::\+Neighbor\+::node}
...
{\footnotesize\ttfamily size\+\_\+t dai\+::\+Neighbor\+::dual}
